...
class Ui_Loading(object):
    def setupUi(self, Loading):
        ...
        self.label.setGeometry(QtCore.QRect(100, 390, 351, 51))
        font = QtGui.QFont()
...
"color: rgb(148, 33, 48);")
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 40, 611, 341))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("images/rental3.jpg"))
        self.label_2.setObjectName("label_2")
        self.progressBar = QtWidgets.QProgressBar(self.frame)
        self.progressBar.setGeometry(QtCore.QRect(80, 460, 421, 23))
...
"}")
    ...
    def retranslateUi(self, Loading):
        ...
        Loading.setWindowTitle(_translate("Loading", "HomeWindow"))
        self.label.setText(_translate("Loading", "Welcome to Bike Rental System"))
